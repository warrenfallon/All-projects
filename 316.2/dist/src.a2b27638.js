...
var topMenuLinks = document.getElementsByTagName("a");
console.log(topMenuLinks);
console.log(topMenuEl);
topMenuEl.addEventListener("click", function (e) {
  console.log(e.preventDefault);
  console.log(e.target);
  for (var _i = 0; _i < topMenuLinks.length; _i++) {
    topMenuLinks[_i].classList.remove("active");
  }
  ...
  if (e.target.innerText === "CATALOG") {
    ...
    for (var n = 0; n < menuLinks[1].subLinks.length; n++) {
  ...
  if (e.target.innerText === "ORDERS") {
    ...
    for (var _n = 0; _n < menuLinks[2].subLinks.length; _n++) {
      var _sublink = document.createElement("a");
      _sublink.href = menuLinks[2].subLinks[_n].href;
      _sublink.innerText = menuLinks[2].subLinks[_n].text;
      console.log(menuLinks[2].subLinks[_n].href);
      console.log(_sublink);
      subMenuEl.appendChild(_sublink);
    }
  }
});
